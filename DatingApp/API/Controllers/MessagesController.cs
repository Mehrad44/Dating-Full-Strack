...
namespace API.Controllers
{
    ...
    {
        var sender = await uow.MemeberRepository.GetMemberByIdAsync(User.GetMemberId());
        var recipient = await uow.MemeberRepository.GetMemberByIdAsync(createMessageDto.RecipientId);
    ...
    public async Task<ActionResult> DeleteMessage(string id)
        {
            ...
            var message = await uow.MessageRepository.GetMessages(id);
            ...
            return BadRequest("You can not delet this message");
